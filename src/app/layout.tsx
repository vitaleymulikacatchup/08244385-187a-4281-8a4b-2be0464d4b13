...
export const metadata: Metadata = {
  ...
  description: "Experience exceptional Italian cuisine at Bella Vista. Savor authentic dishes crafted with passion using the finest ingredients in an elegant dining atmosphere.",
  keywords: "Italian restaurant, fine dining, authentic cuisine, pasta, pizza, seafood, reservations, elegant dining",
  ...
  openGraph: {
    ...
    images: [{
      ...
      alt: "Elegant restaurant dining room at Bella Vista"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Bella Vista - Authentic Italian Fine Dining Restaurant",
    description: "Experience exceptional Italian cuisine at Bella Vista. Savor authentic dishes crafted with passion using the finest ingredients.",
